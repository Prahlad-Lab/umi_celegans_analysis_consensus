...
def calculate_proportions(vcf_file_path, output_tsv_path, summary_file_path):
    """
        ...
        with open(vcf_file_path, 'r') as vcf_in, open(output_tsv_path, 'w') as tsv_out:
            ...
            for line in vcf_in:
                ...
                if dp_match:
                    ...
                    # FILTER 1: Skip sites with read depth < 10
                    if total_reads < 10:
    ...
    print("\n--- Processing Summary ---")
    print(f"Sites skipped due to read depth < 10: {sites_skipped_depth}")
...
def main():
    ...
    calculate_proportions(args.vcf_file, args.output_tsv, args.summary_file)
